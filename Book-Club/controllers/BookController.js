...
exports.deleteBook = async (req, res) => {
    ...
    try {
        ...
        // Ajoutez les logs ici pour vérifier le type et le contenu de book
        console.log('Type de book:', typeof book); // Affiche le type de book
        console.log('Livre trouvé:', book); // Affiche le contenu de book
        ...
        // Supprimer le livre
        await Book.findByIdAndDelete(id); // ou utilisez Book.findByIdAndDelete(id);
